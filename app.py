...
def fecth_poster (movie_id):
    response = requests.get("https://api.themoviedb.org/3/movie/{}?api_key=cfa8e543bfa4883ce314b7357e87618d&language=en-US".format(movie_id))
    data = response.json()
...
selected_movies_name = st.selectbox("How would you like to be contacted?", movies_list['title'].values)
